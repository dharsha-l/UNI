...
// AI Detection — Seeded adapter for reliable demo operation
// ============================================================
export const VisionAIService = {
  async detectObjects(imageId: string, filename: string, category: string): Promise<any[]> {
    await delay(2500);

    // Seeded detection results — matches demo scenario
    // Lab images show 8 total identifiable lab spaces across 2 images
